    ...
    <footer class="border-t border-border bg-background/50 backdrop-blur-sm mt-auto">
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-center gap-4 text-sm text-muted-foreground">
          ...
          <a href="https://free.xn--fiqs8s" target="_blank" rel="noopener noreferrer" class="hover:text-foreground transition-colors">free中国</a>
          <a href="" target="_blank" rel="noopener noreferrer" class="hover:text-foreground transition-colors">敬请期待</a>
